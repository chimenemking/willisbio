        ...
        <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
          ...
          <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64">
            ...
            <div className="flex flex-col gap-12 justify-center">
              ...
              {/* BIOGRAPHY DESC */}
              <p className="text-lg">
                Software Engineer from Nigeria with experience building robust
                and scalable web and mobile applications
              </p>
              {/* BIOGRAPHY QUOTE */}
              <span className="italic">Welcome to my porfolio page</span>
            </div>
            {/*SKILLS CONTAINER  */}
            <div className="flex flex-col gap-12 justify-center">
              {/* SKILL TITLE */}
              ...
              >
                ...
                <div className="flex justify-between h-48">
                  ...
                  <div className="w-1/3 ">
                    {/* JOB TITLE */}
                    <div className="bg-white p-3 font-semibold rounded-b-lg rounded-s-lg">
                      Mid-level React Developer(contract)
                    </div>
                    {/* JOB DESC */}
                    <div className="p-3 text-sm italic">
                      I spearheaded React-based application development,
                      leveraging advanced skills. Built Practice management
                      systems{" "}
                    </div>
                    {/* JOB DATE */}
                    <div className="p-3 text-red-400 text-sm font-semibold">
                ...
                <div className="flex justify-between h-48">
                  ...
                  <div className="w-1/3 ">
                    ...
                    <div className="p-3 text-sm italic">
                      ...
                      to address client requirements and worked on robust
                      applications{" "}
                    </div>
                    {/* JOB DATE */}
                    <div className="p-3 text-red-400 text-sm font-semibold">
                    ...
                    {/* JOB COMPANY */}
                    <div className="p-1 rounded bg-white text-sm font-semibold w-fit">
                     Nigeria Development Foundation
                    </div>
                  </div>
                  {/* CENTER */}
                  <div className="w-1/6 flex justify-center">
